		                	...
		                	<table style="width: 100%">
		                		...
		                		<tbody>
		                			<?php 
										...
										$total_price += ((float)$qty * (float)$itmr['price']);
              ...
              <div class="col mb-3 border" style="background: white;">
                  ...
                  <div class="row">
                      <div class="col-md-6" style="text-align: center;">
                        <img style="height: 100px; width: 152px;" src="images/sbi-card-logo-vector.png">
                        <p class="text-center">Account Number: 34567890123
						</p>
